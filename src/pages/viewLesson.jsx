...
<div className="table-ranking">
    ...
    <div className="content-ranking" key={index}>
      ...
      <div className="col-rankingg">{lesson.startLessonDate}</div>
      <div className="col-rankingg">{lesson.endLessonDate}</div>
...
<div className="pagination-controls" style={{ marginTop: '20px', textAlign: 'center' }}>
  ...
  <span style={{ marginLeft:'10px'}}>{lessonList.length}</span>
</div>
</div>
</TabPanel>
