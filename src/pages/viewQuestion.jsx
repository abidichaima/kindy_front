...
<Dialog open={isPopupOpen} onClose={handleClosePopup}>
  ...
  <DialogContent>
    <AddQuestionForm onClose={handleClosePopup} />
  </DialogContent>
</Dialog>
...
<div className="inner-content inventory">
  <h4 className="title-dashboard">Quizz</h4>
  ...
  <div className="table-ranking">
    ...
    {data.slice(startIndex, endIndex).map((item, index) => (
      <div className="content-ranking" key={index}>
        ...
        <div className="col-rankingg">{item.blockchain}</div>
        <div className="col-rankingg">{item.bid}</div>
        <div className="col-rankingg">{item.views}</div>
...
<button type='submit'   style={btndelete} onClick={DeleteConfirmation}>
<svg
  viewBox="0 0 1024 1024"
  fill="currentColor"
  height="20px"
